# -*- coding: utf-8 -*-
"""
Created on Fri Dec 31 15:38:45 2021

@author: Clark
"""

#load_yolo_weights, read_class_names, image_preprocess, draw_bbox, bboxes_iou, nms, postprocess_boxes, detect_image
...
def detect_image(YoloV3, image_path, output_path, CLASSES, input_size=416, show=False, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
